...
import 'dart:io';
import 'package:amazon_clone/view/seller/add_product_screen/widgets/products_details_common_textfield.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              commonFunctions.blankSpace(height: height * 0.03, width: 0),
              ElevatedButton(
                  onPressed: onPressed,
              ...
              commonFunctions.blankSpace(height: height * 0.09, width: 0),
            ],
          ),
        ),
      ),
  ...
  Column productDetails(double height, TextTheme textTheme, double width) {
    return Column(
      children: [
        ...
        commonFunctions.blankSpace(height: height * 0.015, width: 0),
